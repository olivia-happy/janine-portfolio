...
function renderEducation(education, honors) {
  ...
  return `<section id="education" class="section education-section" aria-labelledby="education-title"><div class="section-heading"><p class="eyebrow">04 / EDUCATION</p><h2 id="education-title">统计学的底子，是判断力的来源。</h2></div><div class="edu-grid reveal">${cards}</div><ul class="honor-list reveal">${honorItems}</ul></section>`;
}
...
export function renderPortfolio({ profile, projects, principles, internships, campusExperiences, education, honors }) {
  ...
  return `<main id="content" data-portfolio-home><div class="pointer-light" aria-hidden="true"></div>
    ...
    <section id="journey" class="section journey-section" aria-labelledby="journey-title"><div class="section-heading"><p class="eyebrow">03 / EXPERIENCE</p><h2 id="journey-title">实习与校园经历，是能力逐步成形的过程。</h2></div><div class="growth-groups"><div class="growth-group" id="journey-work"><div class="growth-group-heading"><p class="eyebrow">WORK / INTERNSHIP</p><h3>实际经历</h3><span>把需求推进成可交付的产品与数据方案</span></div>${workArchive}</div><div class="growth-group" id="journey-campus"><div class="growth-group-heading"><p class="eyebrow">CAMPUS</p><h3>校园经历</h3><span>竞赛与学术场里练出的方法与判断</span></div>${campusArchive}</div></div></section>
    ${renderEducation(education, honors)}
    <section id="contact" class="contact-section" aria-labelledby="contact-title"><p class="eyebrow">05 / CONTACT</p><h2 id="contact-title">期待一次有价值的产品讨论。</h2><p class="contact-availability">${escapeHtml(profile.availability)}</p><div class="contact-links"><a href="mailto:${escapeHtml(profile.contact)}">✉️ ${escapeHtml(profile.contact)}</a><a href="${escapeHtml(profile.github)}" target="_blank" rel="noreferrer">🐙 GitHub 主页 <span aria-hidden="true">↗</span></a></div></section></main>${renderCaseReader(projects)}`;
}
