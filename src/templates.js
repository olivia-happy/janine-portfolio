...
export function renderPortfolio({ profile, projects, principles, internships, campusExperiences }) {
  ...
  return `<main id="content" data-portfolio-home><div class="pointer-light" aria-hidden="true"></div>
    ...
    <section id="contact" class="contact-section" aria-labelledby="contact-title"><p class="eyebrow">04 / CONTACT</p><h2 id="contact-title">期待一次有价值的产品讨论。</h2><div class="contact-links"><a href="mailto:${escapeHtml(profile.contact)}">✉️ ${escapeHtml(profile.contact)}</a><a href="${escapeHtml(profile.github)}" target="_blank" rel="noreferrer">🐙 GitHub 主页 <span aria-hidden="true">↗</span></a></div></section></main>${renderCaseReader(projects)}`;
}
